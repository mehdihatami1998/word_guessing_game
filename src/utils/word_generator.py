...
word_categories = {
    "countries": ["brazil", "peru", "argentina", "chile", "colombia", "uruguay", "paraguay", "bolivia", "venezuela", "ecuador", "guyana", "suriname", "french guiana"],
    ...
    "sports": ["soccer", "basketball", "football", "baseball", "tennis", "volleyball", "golf", "hockey", "rugby", "cricket", "badminton", "bowling", "boxing", "cycling", "fencing", "gymnastics", "horseback riding", "judo", "karate", "skiing", "snowboarding", "swimming", "table tennis", "taekwondo", "track and field", "wrestling"],
    "jobs": ["doctor", "nurse", "teacher", "engineer", "lawyer", "scientist", "programmer", "developer", "designer", "artist", "musician", "actor", "actress", "singer", "dancer", "chef", "cook", "police officer", "firefighter", "soldier", "pilot", "mechanic", "electrician", "plumber", "carpenter", "farmer", "veterinarian", "dentist", "architect", "psychologist", "accountant", "economist", "writer", "journalist", "photographer", "librarian", "cashier", "secretary", "receptionist", "waiter"
    ]
}
